...
function ret = train_and_save(fold)
    mat_path = ['../rnn_tensorflow_output_path/fold',num2str(fold),'/'];
    ...
    train_data = normalize_data(train_data,minX,rangeX,-1,1);
    test_data = normalize_data(test_data,minX,rangeX,-1,1);

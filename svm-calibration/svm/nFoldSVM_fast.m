function [model, cvaccuracy, yhat, testaccuracy] = nFoldSVM_fast(tr_data,te_data,dist_func,nr_fold)
...
[model, cvaccuracy, yhat, testaccuracy] = nFoldSVMMatrix(tr_K,tr_data.y,te_K,te_data.y,nr_fold);
end


function [model, cvaccuracy, yhat, testaccuracy] = nFoldSVMMatrix(tr_K,tr_y,te_K,te_y,nr_fold)
...
[yhat,testaccuracy] = test(model,te_K,te_y);
end
